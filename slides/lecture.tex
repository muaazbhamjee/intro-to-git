...
% ------ Title -----------------------------------------------
\uptitleframe{Introduction to\\Git for Code}{Prof Muaaz Bhamjee\\[0.15cm]{\small Department of Mechanical \& Aeronautical Engineering}}
...
\begin{frame}[fragile]{Switching Remote URLs}
  \vspace{0.5em}
...
\begin{frame}[fragile]{Inspecting History \& Changes}
  \vspace{0.3em}
...
\begin{frame}[fragile]{\texttt{gh} --- Power User Tips}
  \vspace{0.3em}
...
\begin{frame}[fragile]{Keeping Your Fork in Sync}
  \vspace{0.3em}
...
\begin{frame}{The Complete PR Workflow}
  \begin{center}
    \begin{tikzpicture}[
      box/.style={draw, rounded corners, fill=blue!8, minimum width=1cm, minimum height=0.7cm, align=center, font=\scriptsize},
      arr/.style={->, thick, >=Stealth}
    ]
...
\begin{frame}[fragile]{README Skeleton}
  \vspace{0.3em}
...
\begin{frame}[fragile]{How to Add a Licence}
  \vspace{0.3em}
...
\begin{frame}[fragile]{Once Tracked, Always Tracked}
  \vspace{0.5em}
...
\begin{frame}[fragile]{gitignore Best Practices}
  \vspace{0.3em}
...
\begin{frame}[fragile]{Make it Automatic}
  \vspace{0.5em}
